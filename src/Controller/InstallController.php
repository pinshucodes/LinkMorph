...
class InstallController extends AppController
{
    ...
    public function adminuser()
    {
        ...
        if ($this->getRequest()->is('post')) {
            ...
            $user->api_token = bin2hex(random_bytes(32)); // 64-char hex, cryptographically secure
            $user->activation_key = '';
    ...
    protected function createConfigureFile($data)
    {
        ...
        $content = file_get_contents(CONFIG . 'configure.php');
        ...
        if (file_put_contents(CONFIG . 'configure.php', $content) === false) {
